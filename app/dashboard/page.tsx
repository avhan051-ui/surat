...
export default function DashboardPage() {
  ...
  return (
    <Suspense fallback={<LoadingSpinner message="Memuat dashboard..." />}>
      <div className="max-w-7xl mx-auto">
        {loading ? (
          ...
          <div className="space-y-8">
            ...
            {/* Recent Activity and Category Stats Skeleton */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div className="bg-gray-200 rounded-2xl shadow-xl p-8 h-64 animate-pulse"></div>
              <div className="bg-gray-200 rounded-2xl shadow-xl p-8 h-64 animate-pulse"></div>
            </div>
          </div>
        ) : (
